    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            href="/login"
            className="text-xs font-medium uppercase tracking-wider px-4 py-2 border border-border rounded-md text-muted-foreground hover:text-foreground hover:border-foreground transition-colors"
          >
            Log In
          </a>
          <a
            href="/login"
            className="text-xs font-medium uppercase tracking-wider px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
          >
            Get Started
          </a>
        </div>
        ...
        <div className="fixed top-14 left-0 right-0 bg-background border-b border-border z-40 md:hidden">
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-4 space-y-2">
              <a
                href="/login"
                className="block w-full text-center text-xs font-medium uppercase tracking-wider px-4 py-3 border border-border rounded-md text-muted-foreground"
              >
                Log In
              </a>
              <a
                href="/login"
                className="block w-full text-center text-xs font-medium uppercase tracking-wider px-4 py-3 bg-primary text-primary-foreground rounded-md"
              >
                Get Started
              </a>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <div className="font-bold text-xl tracking-tight text-foreground mb-4">PSXL</div>
